...
>> The Bot is Running
>> Bot source > NAPLON
>>Source channel > @rrrrwv
>>Source developer > @LZZZ5
...
if tonumber(user_id) == tonumber(1893155191) then  
var = true  
elseif tonumber(user_id) == tonumber(1893155191) then
var = true  
...
local UserName = (data.username_ or "rrrrwv")
local NameUser = "[- NAPLON 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrrwv)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- NAPLON 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrrwv)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
if result.id_ == tonumber(1893155191) then
...
if userid == tonumber(1893155191) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1893155191) then
...
send(msg.chat_id_, msg.id_,"[- NAPLON 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrrwv)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "rrrrwv")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if NAPLONrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- NAPLON 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/rrrrwv)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "rrrrwv")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."NAPLON:Special:User"..msg.chat_id_,result.id_)  
...
function Function_NAPLON(extra, result, success)
if result.sender_user_id_ == tonumber(1893155191) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1893155191) then
...
local UserName = (b.username_ or "rrrrwv")
...
if text == (database:get(bot_id.."NAPLON:Name:Bot") or "نابليون") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."NAPLON:Name:Bot") or "نابليون")
local namebot = {
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- NAPLON TeAM .',url="t.me/rrrrwv"}},
}
local msg_id = msg.id_/2097152/0.5
...
[⌔︙ NAPLON 𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/rrrrwv)
     
[⌔︙ NAPLON Developer .](http://t.me/LZZZ5)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
inline = {
{{text = '⌔︙ NAPLON 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/rrrrwv'}},
}
...
inline = {
{{text = '⌔︙ NAPLON 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/rrrrwv'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
local Name_Bot = (database:get(bot_id.."NAPLON:Name:Bot") or "نابليون")
