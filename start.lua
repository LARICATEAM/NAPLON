...
print("::NAPLON::")
local RunBot = io.open("NAPLON", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/NAPLON
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr NAPLON.lua
wget "https://raw.githubusercontent.com/LARICATEAM/NAPLON/master/NAPLON.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./NAPLON.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S NAPLON -X kill
screen -S NAPLON ./NAPLON
done
]])
RunTs:close()
end
